    ...
    <div class="carousel-item active">
       <div class="container-fluid marginbottom-100">
                <div class="section-heading heading-dark heading-center">
                    ...
                    <h2 class="item-title">Srap trader subscription Plan</h2>
                </div>
                <div class="row gutters-20">
                    <div class="col-md-4 d-md-none d-lg-none d-block d-xl-block">
                        <div class="pricing-box-layout1">
                            <h3 class="item-title">Steel Plant Details</h3>
                            <div class="item-price">
                                <div class="item-currency">Rs.</div>100<div class="item-duration">Plant</div>
                            </div>
                    ...
                    <div class="col-md-4 d-md-none d-lg-none d-block d-xl-block ">
                        <div class="pricing-box-layout1">
                            <h3 class="item-title">Scrap Sale posting</h3>
                            <div class="item-price">
                                <div class="item-currency"></div>Normal Fees
                            </div>
                            <div class="item-content">
                    ...
                    <div class="col-md-4 d-md-none d-lg-none d-block d-xl-block ">
                        <div class="pricing-box-layout1">
                            <h3 class="item-title">Scrap Sale Posting Featured</h3>
                            <div class="item-price">
                                <div class="item-currency">Rs.</div>500<div class="item-duration">Posting</div>
                            </div>
                            <div class="item-content">
