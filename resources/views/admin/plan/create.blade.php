...
@endif
                        <div class="col-md-12 col-12">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal" method="post" action="{{url('admin/plan')}}" enctype="multipart/form-data">
                                              @csrf
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="position-relative has-icon-left">
                                                                    <input type="text" id="fname-icon" class="form-control" name="PlanName" placeholder="Title">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="position-relative has-icon-left">
                                                                    ...
                                                                    <select class="form-control" name="PlanType">
                                                                        ...
                                                                        <option value="Steel Trader">Steel Trader</option>
                                                                        <option value="Scrap Generator">Scrap Generator </option>
                                                                    </select>
                                                                    <div class="form-control-position">
