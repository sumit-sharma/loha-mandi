                                                ...
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" class="form-control" value="{{$user->products}}" placeholder="Products here..." name="products" ndata-validation-required-message="This Product  is required">
                                                        </div>
                                                    </div>
                                                </div>
                                                 <div class="col-12 col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" class="form-control" required placeholder="Website here..." value="{{$user->type_of_unit}}" name="type_of_unit"data-validation-required-message="This monthly scrap required field is required">
                                                        </div>
                                                    </div>
                                                </div>
                                                 <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" class="form-control" required placeholder="Website here..." value="{{$user->installed_capacity}}" name ="installed_capacity" data-validation-required-message="This monthly scrap required field is required">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Monthly Production</label>
                                                            <input type="text" class="form-control" required placeholder="Monthly Production" value="{{$user->production}}"  name ="monthly_production" data-validation-required-message="This monthly scrap required field is required">
                                                        </div>
                                                    </div>
                                                </div>
                                                  ...
                                                  <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="hidden" class="form-control" required value="{{$user->city}}" name ="city" data-validation-required-message="This Time Zone field is required">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="hidden" class="form-control" required value="{{$user->state}}" name="state" data-validation-required-message="This Time Zone field is required">
                                                        </div>
                                                    </div>
                                                </div>
                                                   <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Country</label>
                                                            <input type="text" class="form-control" required value="{{$user->country}}" name ="country" data-validation-required-message="This Time Zone field is required" disabled>
                                                        </div>
                                                    </div>
                                                      <div class="form-group">
                                                        <div class="controls">
                                                            <label>GST/CIN</label>
                                                            <input type="text" class="form-control" required value="{{$user->cin_no_or_gst}}" name ="cin_no_or_gst" data-validation-required-message="This Time Zone field is required">
                                                        </div>
                                                    </div>
                                                </div>
