                                            ...
                                            <div class="row">
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="email" class="form-control" placeholder="Established year" value="{{$user->established_year}}"  name ="established_year" required data-validation-required-message="This email field is required">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Website</label>
                                                ...
                                                <div class="col-12 col-sm-6">
                                                 ...
                                                 <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Monthly scrap Supply</label>
                                                            <input type="text" class="form-control" required placeholder="Monthly scrap Supply..." name="monthly_scrap_required" value="{{$user->monthly_scrap_required}}" data-validation-required-message="This monthly scrap required field is required">
                                                        </div>
                                                    </div>
