                                ...
                                <div class="card-body">
                                   ...
                                   <img src="{{ url('/images/'.$picture) }}" class="users-avatar-shadowrounded mb-2 pr-2 ml-1" style="height:80px; width:80px"/>
                                        ...
                                        <div class="col-12 mt-3">
                                            ...
                                            <a href="{{url('admin/edit/user/'.$user->id)}}" class="btn btn-outline-danger"><i class="feather icon-trash-2"></i> Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table>
                                        ...
                                        <tr>
                                            <td class="font-weight-bold">Monthly scrap production :</td>
                                            <td>{{$user->monthly_scrap_production}}
                                            </td>
                                        </tr>
