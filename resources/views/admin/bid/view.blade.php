                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Plant Detail</div>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <img src="{{url('/images/'.$user->$images)}}" class="users-avatar-shadow w-100 rounded mb-2 pr-2 ml-1" alt="{{$user->company_name}}" style="width: 100px;height: 100px;">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table>
                                        ...
                                        <tr>
                                            <td class="font-weight-bold">GST/TIN No.:</td>
                                        ...
                                        <tr>
                                            <td class="font-weight-bold">Installed Capacity :</td>
                                            <td>{{$user->installed_capacity}}
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="font-weight-bold">Monthly Production :</td>
                                            <td>{{$user->monthly_production}}
                                            </td>
                                        </tr>
                                        <tr>
